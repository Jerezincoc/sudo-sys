...
* **Limitação de evidência (registrada por honestidade):**
  ...
  * **Correção posterior (mesma ação):** a primeira transcrição do §8º feita nesta ação **parou em "caso seja mais benéfico ao contribuinte"**, omitindo o final do dispositivo. O texto foi conferido na própria `IN RFB nº 2.141/2023` (art. 1º, que dá a nova redação) e o parágrafo termina em **"..., dispensadas a comprovação da despesa e a indicação de sua espécie."** — mesmo fecho que a `Lei 9.250/1995`, art. 4º, §2º usa para o desconto simplificado mensal. A citação acima já está completa. A omissão não muda a conclusão da `REC-0022`.
